...
File: atm.py
Project 8.4
This modulefinder de!nes the ATM class and its application.
Modi!es the user interface so that it prints a message and shuts down
if the user fails at three consecutive logins.
Can be modi!ed to run as a script after a bank has been saved.
'''
